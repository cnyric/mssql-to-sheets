...
/** # log
  Creates a new instance of the `Logger` class, which is used throughout the application to log messages to the console.
...
/** # errorHandler
  The function first writes a log message to a file specified by the `ERROR_LOG_PATH` environment variable, then logs the error message to the console. Finally, it exits the Node.js process.
